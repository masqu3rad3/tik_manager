...
def get_environment_data():
    ...
    all_dcc_data = {
        "maya": {
            ...
            "core_package": "MayaCoreFunctions",
            ...
            "scene_formats": ["mb", "ma"],
            "asset_formats": ["mb", "ma"],
            "qt_module": "tik_manager.ui.Qt",
        },
        "3dsmax": {
            "dcc": "3dsmax",
            "core_module": "tik_manager.dcc.max.core_max",
            "core_package": "MaxCoreFunctions",
        ...
        "houdini": {
            ...
            "core_package": "HoudiniCoreFunctions",
        ...
        "nuke": {
            ...
            "core_package": "NukeCoreFunctions",
        ...
        "standalone": {
            ...
            "core_package": "StandaloneCoreFunctions",
